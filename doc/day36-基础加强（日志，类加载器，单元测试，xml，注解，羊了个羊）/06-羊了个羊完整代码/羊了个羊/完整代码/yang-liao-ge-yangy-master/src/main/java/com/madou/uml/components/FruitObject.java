package com.madou.uml.components;
...
public class FruitObject  {
    ...
    static {
        try {
            URL clickSound = ReadResourceUtil.readAudio("click.wav");
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new BufferedInputStream(clickSound.openStream()));
